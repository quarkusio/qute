...
* `quarkus.qute.basePath` - a path relative from `META-INF/resources/`; all files in the base directory and its subdirectories are considered templates and watched for changes in the development mode
